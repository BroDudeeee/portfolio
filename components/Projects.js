    ...
    <div className="max-w-4xl mx-auto p-4 mb-14 flex flex-col justify-center items-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2">
        {projects.map(({ id, img, name, link }) => (
          <div
            key={id}
            className="relative hover:bg-blue-600 flex items-center justify-center text-center m-4 group border-2 border-gray-200 shadow-md rounded-xl h-52 sm:h-80 w-52 sm:w-96"
          >
            <img
              src={img}
              alt="project"
